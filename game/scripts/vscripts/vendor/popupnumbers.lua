...
function PopupCriticalDamage(target, amount)
    PopupNumbers(target, "crit", Vector(255, 0, 0), 1.2, amount, nil, POPUP_SYMBOL_POST_LIGHTNING)
end
...
function PopupExperience(target, amount)
    PopupNumbers(target, "miss", Vector(154, 46, 254), 2.0, amount, POPUP_SYMBOL_PRE_PLUS, nil, true, true)
end
