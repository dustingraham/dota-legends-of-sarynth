...
function UpdateItem()
{
	...
	// Doesn't quite work... plus does not have gray or quest colors.
	// Plus does not color the item itself like the classes above.
	// var c = Items.GetItemColor(m_Item);
	// var a = (c >> 24) & 0xFF
	// var r = (c >> 16) & 0xFF;
	// var g = (c >> 8) & 0xFF;
	// var b = (c) & 0xFF;
