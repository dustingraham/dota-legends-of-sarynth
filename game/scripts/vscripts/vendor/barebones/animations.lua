...
LinkLuaModifier( "modifier_animation", "vendor/barebones/modifiers/modifier_animation", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_animation_translate", "vendor/barebones/modifiers/modifier_animation_translate", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_animation_translate_permanent", "vendor/barebones/modifiers/modifier_animation_translate_permanent", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_animation_freeze", "vendor/barebones/modifiers/modifier_animation_freeze", LUA_MODIFIER_MOTION_NONE )
